...
const ExecutionPage = lazyPage(
  () => import("./pages/ExecutionPage.jsx"),
  "ExecutionPage",
);
const InstructionsPage = lazyPage(
  () => import("./pages/InstructionsPage.jsx"),
  "InstructionsPage",
);
...
const PlanningPage = lazyPage(
  () => import("./pages/PlanningPage.jsx"),
  "PlanningPage",
);
const RankingPage = lazyPage(
  () => import("./pages/RankingPage.jsx"),
  "RankingPage",
);
const ResultPage = lazyPage(
